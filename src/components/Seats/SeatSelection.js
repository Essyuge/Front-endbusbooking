        ...
        return seatArray.map((seat, idx) => {
            return (
              ...
              <div className="form-check form-check-inline">
                  ...
                  <label style={{color:"black"}} className="form-check-label" for="male">Female</label>
              </div>
              <div className="form-check form-check-inline">
                  <input className="form-check-input" type="radio" name="gender" id="female" value="Female" onClick={e => handleGender(e, seat)} />
                  <label style={{color:"black"}} className="form-check-label" htmlFor="female">Male</label>
              </div>
          </form>
      </div>)
        ...
        <div> <div>
            <ul className="nav nav-pills">
                <li className="nav-item">
                    <a  style={{backgroundColor:"#839788",color:"white"}}className="nav-link active" data-toggle="pill" href="/seat-selection">Select Seat</a>
                </li>
                <li className="nav-item">
                    <a  style={{color:"black"}} className="nav-link" data-toggle="pill" href="/payment">Payment</a>
                </li>
            </ul>
        </div>
            <div className="ss">
                    ...
                    <div className="column2">
                        <div className="seatInfo">
                            ...
                            <div>
                                ...
                                <button style={{backgroundColor:"#839788",color:"white"}} onClick={e => handleSubmitDetails(e)} className="btn btn-info seatBT">
                                    Confirm Details
                                </button>
                            </div>
